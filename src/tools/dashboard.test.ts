...
function makeMockStore(nodes: Record<string, unknown>[], stats?: Partial<FractalStats>): MemoryStore {
  return {
    ...
    logToolCall: async () => { /* empty */ },
    pruneUsageLog: async () => 0,
    ensureSeed: async () => { /* empty */ },
    ...
    updateNode: async () => { /* empty */ },
    deleteNode: async () => { /* empty */ },
    ...
    backfillBinaryEmbeddingsAndBM25: async () => { /* empty */ },
    rebuildHNSWIndex: async () => { /* empty */ },
    logInjectionMetrics: async () => { /* empty */ },
    recordMemoryToolCall: async () => { /* empty */ },
    finalizeInjection: async () => { /* empty */ },
    recordInjectionFeedback: async () => { /* empty */ },
    getInjectionMetrics: async () => [],
    getSessionStats: async () => null,
    recordAgentToolCall: async () => { /* empty */ },
    createSessionMetrics: async () => { /* empty */ },
    updateSessionMetrics: async () => { /* empty */ },
    incrementSessionToolCall: async () => { /* empty */ },
    getSessionMetrics: async () => null,
    getPendingInjections: async () => [],
    markInjectionProcessed: async () => { /* empty */ },
    close: async () => { /* empty */ },
