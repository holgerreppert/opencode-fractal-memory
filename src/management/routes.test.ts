...
describe("Router", () => {
  ...
  test("registerRoutes binds all API routes", async () => {
    ...
    const routes: Array<{ path: string; method: string }> = [
      ...
      { path: "/api/context-pressure", method: "GET" },
      { path: "/api/context-archive", method: "GET" },
      { path: "/api/graph/projects", method: "GET" },
      { path: "/api/graph", method: "GET" },
      { path: "/api/graph/export", method: "GET" },
      { path: "/api/graph/search?q=test", method: "GET" },
      { path: "/api/graph/usage", method: "GET" },
      { path: "/api/graph/build", method: "POST" },
      { path: "/api/graph/path", method: "POST" },
      { path: "/api/graph/explain", method: "POST" },
