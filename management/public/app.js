...
function getGeometry(shape, size) {
  switch (shape) {
    ...
    case "capsule": return new THREE.CapsuleGeometry(size * 0.6, size * 0.8, 4, 12);
    case "torus": return new THREE.TorusGeometry(size * 0.9, size * 0.35, 12, 24);
    case "torusKnot": return new THREE.TorusKnotGeometry(size * 0.7, size * 0.22, 32, 8, 2, 3);
...
function buildLegend() {
  ...
  html += `<div class="legend-item"><div class="legend-dot" style="background: #60a5fa; border-radius: 30% 30% 0 0;"></div><span class="legend-label">Cylinder = Plan</span></div>`;
  ...
  html += `<div style="margin-top:6px; font-weight: 600; color: #aaa; font-size:11px;">C · Organic — soft/elongated (episodic)</div>`;
  ...
  html += `<div class="legend-item"><div class="legend-dot" style="background: #34d399; border-radius: 999px; width: 16px;"></div><span class="legend-label">Capsule = Howto / Improvement / Exploration</span></div>`;
  html += `<div class="legend-item"><div class="legend-dot" style="background: #ff6b6b; clip-path: polygon(50% 0%, 0% 100%, 100% 100%); opacity:0.9;"></div><span class="legend-label">Tetrahedron (red) = Event / Episode</span></div>`;
